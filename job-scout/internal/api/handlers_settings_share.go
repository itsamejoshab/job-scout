...
func (h *Handler) shareableSettings(r *http.Request) (settingshare.Bundle, error) {
	...
	return settingshare.Bundle{
		...
		Search: settingshare.Search{
			...
			OnsiteKeywords:   nonNilList(search.OnsiteKeywords),
			RemoteKeywords:   nonNilList(search.RemoteKeywords),
			HybridKeywords:   nonNilList(search.HybridKeywords),
		},
		Providers: providers,
	}, nil
}
...
func (h *Handler) prepareSharedSettings(bundle settingshare.Bundle) (preparedShare, error) {
	out := preparedShare{
		search: db.SearchSettings{
			...
			OnsiteKeywords:   cloneList(bundle.Search.OnsiteKeywords),
			RemoteKeywords:   cloneList(bundle.Search.RemoteKeywords),
			HybridKeywords:   cloneList(bundle.Search.HybridKeywords),
		},
